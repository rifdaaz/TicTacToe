...
$sql = "SELECT * FROM ".$dbname.".`users` WHERE username='".$user."'";
...
if($result->num_rows>0){
  ...
  $sql = "INSERT INTO ".$dbname.".`users`(`username`, `password`, `email`) VALUES ('".$user."','".$pass."','".$email."')";
...
<div class="container text-center" style="max-width: 450px;" >
  ...
  <hr >
    ...
    <div class="form-group text-left center-block"  ><br>
